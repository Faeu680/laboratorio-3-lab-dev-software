...
@Module({
  imports: [
    TypeOrmModule.forFeature([TransactionEntity, TeacherEntity, StudentEntity, BenefitEntity]),
  ],
  controllers: [TransactionsController],
  providers: [TransferCoinsUseCase, RedeemBenefitUseCase, GetExtractUseCase, GetBalanceUseCase],
